...
const ReleaseUrl = "https://api.github.com/repos/LunaisLazier/Mooncord/releases/latest"
const ReleaseUrlFallback = "https://vencord.dev/releases/vencord"
const InstallerReleaseUrl = "https://api.github.com/repos/LunaisLazier/Mooncord/releases/latest"
